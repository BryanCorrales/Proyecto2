...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-10-2016 a las 19:22:05
...
(2, 'tubo de abasto inodoro trebol', 18, '1/2x7/8x35cm', 5, 18, -0),
(3, 'tubo de abasto labatorio Metuza', 18, '1/2x7/8x40cm	', 5, 10, 0),
(4, 'tubo de abasto labatorio Trebol', 18, '1/2x7/8x40cm', 5, 10, 8),
(5, 'valvula de base Concyssa', 15, '1/2 pulgada	', 5, 8, 7),
(6, 'plancha de batir Stanley', 20, '7 pulgadas	', 5, 12, 8),
(7, 'plancha de batir Camasa', 15, '7 pulgadas', 5, 8, 7),
(8, 'plancha empastar Stanley', 25, '280x130mn', 5, 15, 10),
(9, 'plancha de empastar FyG', 20, '11px5	', 5, 12, 8),
(10, 'plancha de canto dentado FyG', 20, '11px5', 5, 12, 8),
(11, 'plancha de batir (vadilejo) Wins', 10, '7 pulgadas', 5, 4, 6),
(12, 'gruna de canto nacional', 10, '6x2.5cm', 5, 3.5, 6.5),
...
(49, 'Extension FG', 3, '1/2x2p', 5, 1, 2),
(50, 'Extension FG', 3, '1/2x3p', 5, 1, 2),
(51, 'Extension FG', 4, '1/2x4p', 5, 1.5, 0),
(52, 'Curvo PBC Sel', 5, '3/4p', 5, 2.4, 0),
(53, 'Duchas Nacionales ', 23, 'Cromado', 5, 13, 10),
(54, 'Duchas Nacionales', 7, 'Plastico', 5, 2.5, 4.5),
...
(66, 'Canio de lavadero de Cocina', 28, 'Nacional', 5, 16, 12),
(67, 'Canio PBC PCP', 20, 'PBC', 5, 8, 12),
(68, 'Valvula de media PBC', 5, '1/2p Importado', 5, 1.5, 3.5),
...
(101, 'Interruptor Termo-magnetico Stronger', 20, '2x25A', 5, 10, 10),
(102, 'Extension 3 salidas x 3m Rema', 5, 'Importado	', 5, 2.5, 2.5),
(103, 'Triple Epem', 3.5, '250v 6A', 5, 1.6, 1.9),
