...
--
-- Servidor: localhost
-- Tiempo de generación: 17-09-2016 a las 18:10:57
...
ALTER TABLE `table_Facturas`
  ...
  ADD KEY `llavesForaneas_Vendedor_idx` (`vendedor`),
...
--
ALTER TABLE `table_Facturas`
  ADD CONSTRAINT `llavesForaneas_Cliente` FOREIGN KEY (`cliente`) REFERENCES `table_Cliente` (`idCliente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `llavesForaneas_Vendedor` FOREIGN KEY (`vendedor`) REFERENCES `table_Vendedor` (`idVendedor`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `table_Ventas`
--
ALTER TABLE `table_Ventas`
  ADD CONSTRAINT `llavesForaneas_Facturas` FOREIGN KEY (`No_Facturas`) REFERENCES `table_Facturas` (`No_Facturas`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `llavesForaneas_Productos` FOREIGN KEY (`Productos`) REFERENCES `table_Productos` (`idProductos`) ON DELETE NO ACTION ON UPDATE NO ACTION;
